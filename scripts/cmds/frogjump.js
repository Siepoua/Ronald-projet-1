...
async function moveFrog(chosenBox, message, api, usersData) {
    ...
    if (snakePositions.includes(chosenBox)) {
        ...
        if (coinsEarned > 0) {
            gameOverMessage = `☺𝙀𝙣 𝙛𝙖𝙘𝙚, 𝙡𝙚𝙨 𝙜𝙧𝙚𝙣𝙤𝙪𝙞𝙡𝙡𝙚𝙨 𝙤𝙣𝙩 é𝙩é 𝙢𝙖𝙣𝙜é𝙚𝙨 𝙥𝙖𝙧 𝙪𝙣 𝙨𝙚𝙧𝙥𝙚𝙣𝙩 🐍 𝙘𝙝𝙚𝙯 𝘾𝙝𝙧𝙞𝙨𝙩𝙚𝙡𝙡𝙚 👻.\n𝙢𝙖𝙞𝙨 𝙩𝙪 𝙖𝙨 𝙜𝙖𝙜𝙣é 𝙘𝙝𝙚𝙯 𝘾𝙝𝙧𝙞𝙨𝙩𝙚𝙡𝙡𝙚 👻 ${𝙋𝙞è𝙘𝙚𝙨 𝙜𝙖𝙜𝙣é𝙚𝙨 𝙘𝙝𝙚𝙯 𝘾𝙝𝙧𝙞𝙨𝙩𝙚𝙡𝙡𝙚 👻} coins.`;
    ...
    if (chosenBox <= 4 && !snakePositions.includes(chosenBox)) {
        ...
        const sentMessage = await message.reply("🥳𝙁é𝙡𝙞𝙘𝙞𝙩𝙖𝙩𝙞𝙤𝙣𝙨 ! 𝙑𝙤𝙪𝙨 𝙖𝙫𝙚𝙯 𝙜𝙖𝙜𝙣é 1 𝙡𝙖𝙠𝙝 𝙙𝙚 𝙥𝙞è𝙘𝙚𝙨 𝙘𝙝𝙧𝙞𝙨𝙩𝙚𝙡𝙡𝙚 👻!");
