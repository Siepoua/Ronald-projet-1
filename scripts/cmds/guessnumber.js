...
module.exports = {
	...
	langs: {
		...
		en: {
			charts: "🏆 | 𝘾𝙡𝙖𝙨𝙨𝙚𝙢𝙚𝙣𝙩 👻:\n%1",
			pageInfo: "𝙋𝙖𝙜𝙚 👻 %1/%2",
			noScore: "⭕ | 𝙄𝙡 𝙣'𝙮 𝙖 𝙥𝙚𝙧𝙨𝙤𝙣𝙣𝙚 𝙦𝙪𝙞 𝙖 𝙢𝙖𝙧𝙦𝙪é 👻.",
			noPermissionReset: "⚠️ | 𝙑𝙤𝙪𝙨 𝙣'𝙖𝙫𝙚𝙯 𝙥𝙖𝙨 𝙡𝙖 𝙥𝙚𝙧𝙢𝙞𝙨𝙨𝙞𝙤𝙣 𝙙𝙚 𝙧é𝙞𝙣𝙞𝙩𝙞𝙖𝙡𝙞𝙨𝙚𝙧 𝙡𝙚 𝙘𝙡𝙖𝙨𝙨𝙚𝙢𝙚𝙣𝙩 𝙖 𝙥𝙖𝙧𝙩 𝙘𝙝𝙧𝙞𝙨_👻.",
			notFoundUser: "⚠️ | 𝙄𝙢𝙥𝙤𝙨𝙨𝙞𝙗𝙡𝙚 𝙙𝙚 𝙩𝙧𝙤𝙪𝙫𝙚𝙧 𝙡'𝙪𝙩𝙞𝙡𝙞𝙨𝙖𝙩𝙚𝙪𝙧 𝙖𝙫𝙚𝙘 𝙡'𝙄𝘿 %1 𝙙𝙖𝙣𝙨 𝙡𝙚 𝙘𝙡𝙖𝙨𝙨𝙚𝙢𝙚𝙣𝙩 👻.",
			userRankInfo: "🏆 | 𝙄𝙣𝙛𝙤𝙧𝙢𝙖𝙩𝙞𝙤𝙣𝙨 𝙨𝙪𝙧 𝙡𝙚 𝙘𝙡𝙖𝙨𝙨𝙚𝙢𝙚𝙣𝙩 👻:\n𝙉𝙤𝙢: %1\nScore: %2\n𝙉𝙤𝙢𝙗𝙧𝙚 𝙙𝙚 𝙟𝙚𝙪𝙭 👻: %3\n𝙉𝙤𝙢𝙗𝙧𝙚 𝙙𝙚 𝙫𝙞𝙘𝙩𝙤𝙞𝙧𝙚𝙨 👻: %4\n%5\nNumber of losses: %6\nWin rate: %7%\nTotal play time: %8",
			digits: "%1 𝙘𝙝𝙞𝙛𝙛𝙧𝙚𝙨: %2",
			resetRankSuccess: "✅ | 𝙍é𝙞𝙣𝙞𝙩𝙞𝙖𝙡𝙞𝙨𝙖𝙩𝙞𝙤𝙣 𝙙𝙪 𝙘𝙡𝙖𝙨𝙨𝙚𝙢𝙚𝙣𝙩 𝙧é𝙪𝙨𝙨𝙞𝙚 𝘾𝙝𝙧𝙞𝙨𝙩𝙚𝙡𝙡𝙚 𝙡𝙚 𝙛𝙖𝙣𝙩ô𝙢𝙚 👻.",
			invalidCol: "⚠️ | 𝙑𝙚𝙪𝙞𝙡𝙡𝙚𝙯 𝙨𝙖𝙞𝙨𝙞𝙧 𝙡𝙚 𝙣𝙤𝙢𝙗𝙧𝙚 𝙙𝙚 𝙘𝙝𝙞𝙛𝙛𝙧𝙚𝙨 𝙙𝙪 𝙣𝙪𝙢é𝙧𝙤 à 𝙙𝙚𝙫𝙞𝙣𝙚𝙧, 𝙨𝙤𝙞𝙩 4, 5 𝙤𝙪 6 👻",
			invalidMode: "⚠️ | 𝙑𝙚𝙪𝙞𝙡𝙡𝙚𝙯 𝙞𝙣𝙙𝙞𝙦𝙪𝙚𝙧 𝙨𝙞 𝙡𝙚 𝙢𝙤𝙙𝙚 𝙙𝙚 𝙟𝙚𝙪 𝙚𝙨𝙩 𝙨𝙞𝙢𝙥𝙡𝙚 𝙤𝙪 𝙢𝙪𝙡𝙩𝙞𝙥𝙡𝙚 👻",
			created: "✅ | 𝘾𝙧é𝙚𝙧 𝙪𝙣 𝙟𝙚𝙪 𝙖𝙫𝙚𝙘 𝙨𝙪𝙘𝙘è𝙨. 👻",
			gameName: "𝙅𝙀𝙐 𝘿𝙀 𝘿𝙀𝙑𝙄𝙉𝙀𝙕 𝙇𝙀𝙎 𝙉𝙐𝙈É𝙍𝙊𝙎 👻",
			gameGuide: "⏳ | 𝘾𝙤𝙢𝙢𝙚𝙣𝙩 𝙟𝙤𝙪𝙚𝙧 👻:\n𝙑𝙤𝙪𝙨 𝙖𝙫𝙚𝙯 %1 𝙨𝙪𝙥𝙥𝙤𝙨𝙞𝙩𝙞𝙤𝙣𝙨.👻.\n𝘼𝙥𝙧è𝙨 𝙘𝙝𝙖𝙦𝙪𝙚 𝙨𝙪𝙥𝙥𝙤𝙨𝙞𝙩𝙞𝙤𝙣, 𝙫𝙤𝙪𝙨 𝙤𝙗𝙩𝙞𝙚𝙣𝙙𝙧𝙚𝙯 𝙙𝙚𝙨 𝙞𝙣𝙙𝙞𝙘𝙚𝙨 𝙨𝙪𝙥𝙥𝙡é𝙢𝙚𝙣𝙩𝙖𝙞𝙧𝙚𝙨 𝙨𝙪𝙧 𝙡𝙚 𝙣𝙤𝙢𝙗𝙧𝙚 𝙙𝙚 𝙘𝙝𝙞𝙛𝙛𝙧𝙚𝙨 𝙘𝙤𝙧𝙧𝙚𝙘𝙩𝙨 (𝙞𝙣𝙙𝙞𝙦𝙪é à 𝙜𝙖𝙪𝙘𝙝𝙚) 𝙚𝙩 𝙡𝙚 𝙣𝙤𝙢𝙗𝙧𝙚 𝙙𝙚 𝙘𝙝𝙞𝙛𝙛𝙧𝙚𝙨 𝙘𝙤𝙧𝙧𝙚𝙘𝙩𝙨 (𝙞𝙣𝙙𝙞𝙦𝙪é à 𝙙𝙧𝙤𝙞𝙩𝙚)👻.",
			gameNote: "📄 | 𝙉𝙤𝙩𝙚 👻:\n𝙇𝙚 𝙣𝙤𝙢𝙗𝙧𝙚 𝙚𝙨𝙩 𝙛𝙤𝙧𝙢é 𝙙𝙚 𝙘𝙝𝙞𝙛𝙛𝙧𝙚𝙨 𝙙𝙚 0 à 9, 𝙘𝙝𝙖𝙦𝙪𝙚 𝙘𝙝𝙞𝙛𝙛𝙧𝙚 𝙣'𝙖𝙥𝙥𝙖𝙧𝙖î𝙩 𝙦𝙪'𝙪𝙣𝙚 𝙨𝙚𝙪𝙡𝙚 𝙛𝙤𝙞𝙨 𝙚𝙩 𝙡𝙚 𝙣𝙤𝙢𝙗𝙧𝙚 𝙥𝙚𝙪𝙩 𝙘𝙤𝙢𝙢𝙚𝙣𝙘𝙚𝙧 𝙥𝙖𝙧 👻.",
			replyToPlayGame: "🎮 | 𝙍é𝙥𝙤𝙣𝙙𝙚𝙯 𝙖𝙪 𝙢𝙚𝙨𝙨𝙖𝙜𝙚 𝙘𝙞-𝙙𝙚𝙨𝙨𝙤𝙪𝙨 𝙖𝙫𝙚𝙘 𝙡'𝙞𝙢𝙖𝙜𝙚 𝙙𝙚𝙨 𝙣𝙤𝙢𝙗𝙧𝙚𝙨 %1 𝙦𝙪𝙚 𝙫𝙤𝙪𝙨 𝙖𝙫𝙚𝙯 𝙙𝙚𝙫𝙞𝙣é𝙨 𝙥𝙤𝙪𝙧 𝙟𝙤𝙪𝙚𝙧 𝙖𝙪 𝙟𝙚𝙪. 👻",
			invalidNumbers: "⚠️ | 𝙑𝙚𝙪𝙞𝙡𝙡𝙚𝙯 𝙨𝙖𝙞𝙨𝙞𝙧 %1 𝙣𝙤𝙢𝙗𝙧𝙚𝙨 𝙦𝙪𝙚 𝙫𝙤𝙪𝙨 𝙨𝙤𝙪𝙝𝙖𝙞𝙩𝙚𝙯 𝙙𝙚𝙫𝙞𝙣𝙚𝙧 👻",
			win: "🎉 | 𝙁é𝙡𝙞𝙘𝙞𝙩𝙖𝙩𝙞𝙤𝙣𝙨, 𝙫𝙤𝙪𝙨 𝙖𝙫𝙚𝙯 𝙙𝙚𝙫𝙞𝙣é 𝙡𝙚 𝙣𝙤𝙢𝙗𝙧𝙚 %1 𝙖𝙥𝙧è𝙨 %2 𝙨𝙪𝙥𝙥𝙤𝙨𝙞𝙩𝙞𝙤𝙣𝙨 𝙚𝙩 𝙖𝙫𝙚𝙯 𝙧𝙚ç𝙪 %3 𝙥𝙤𝙞𝙣𝙩𝙨 𝙗𝙤𝙣𝙪𝙨 👻.",
			loss: "🤦‍♂️ | 𝙑𝙤𝙪𝙨 𝙖𝙫𝙚𝙯 𝙥𝙚𝙧𝙙𝙪, 𝙡𝙚 𝙗𝙤𝙣 𝙣𝙪𝙢é𝙧𝙤 𝙚𝙨𝙩 %1 👻."
		}
	},
